...
<head>
    ...
    <title>Primeiro Projeto Mentoria</title>
...
<body>
   ...
   <section class="main">
        ...
        <div class="center">
            ...
            <div class="menu">
                <div class="logo-menu">
                    <a href="http://"><img src="images/logoagencia.svg" alt=""></a>
                </div><!--logo-menu-->

                <div class="items-menu">
                    <a href="http://">Inicio</a>
                    <a href="http://">Por que nós?</a>
            ...
            <div class="mockup">
                <h1>Promova experiencia aos seus clientes!</h1>
                <br>
                <p>E veja resultados expresivos dia após dia</p>
                <br>
   ...
   <section class="cta">
    ...
    <h4>Fale agora mesmo com um de nosso consultores!</h4>
   ...
   <section class="beneficios">
    ...
    <div style="max-width: 1050px;" class="center">
...
<section class="depoimentos">
    ...
    <div style="display:block;" class="center">
        ...
        <div style="max-width: 1200px;" class="container-slider">
            ...
            <div class="container-slider-single">
                <img src="images/DEPOIMENTO2.png" />
                <h3>Lucas Mendes</h3>
                <p>The North Face</p>
            ...
            <div class="container-slider-single">
                <img src="images/DEPOIMENTO3.png" />
                <h3>Zaya Menphis</h3>
                <p>Rappi</p>
